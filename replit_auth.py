...
def make_replit_blueprint():
    try:
        ...
        # Для локального запуска используем тестовый ID
        repl_id = os.environ.get('REPL_ID', 'local-dev-mode')
        if repl_id == 'local-dev-mode':
            logging.warning("Running in local development mode without Replit Auth")
